...
def lammps_gen_graphite_reaxff(**kwargs):

    # Default keyword args
    verbose = kwargs.get('verbose', False)
    forced = kwargs.get('forced', False)
    # Default constants for the ReaxFF May Potl
    a_const = kwargs.get('a_const', 2.433)
    ...
    if(gen_file):
        ...
        # Write header info
        file.write("Lammps data file generated by lammps_gen_graphite_reaxff\n")
            ...
            for y in range(0,cells[1]):
                ...
                for z in range(0,cells[2]):
                    for l in range(0,len(stacking)):
                        ...
                        # stacking position a
                        if( stacking[l] == 'a'):
                            file.write(str(count) + "  1  0  " + str(Xshift) + "  " + str(Yshift) + "  " + str(Zshift) + "\n")
                            file.write(str(count+1) + "  1  0  " + str(Xshift + a_const * 2.0/math.sqrt(3)) + "  " + str(Yshift) + "  " + str(Zshift) + "\n")
                            file.write(str(count+2) + "  1  0  " + str(Xshift + a_const * math.sqrt(3)/6.0) + "  " + str(Yshift + a_const /2.0) + "  " + str(Zshift) + "\n")
                            file.write(str(count+3) + "  1  0  " + str(Xshift + a_const * math.sqrt(3)/2.0) + "  " + str(Yshift + a_const /2.0) + "  " + str(Zshift) + "\n")
                            count = count + 4
                        # stacking position b
                        elif(stacking[l] == 'b'):
                            file.write(str(count) + "  1  0  " + str(Xshift) + "  " + str(Yshift) + "  " + str(Zshift) + "\n")
                            file.write(str(count+1) + "  1  0  " + str(Xshift + a_const / math.sqrt(3)) + "  " + str(Yshift) + "  " + str(Zshift) + "\n")
                            file.write(str(count+2) + "  1  0  " + str(Xshift + a_const * math.sqrt(3)/2.0) + "  " + str(Yshift + a_const /2.0) + "  " + str(Zshift) + "\n")
                            file.write(str(count+3) + "  1  0  " + str(Xshift + a_const * math.sqrt(3)*5.0/6.0) + "  " + str(Yshift + a_const /2.0) + "  " + str(Zshift) + "\n")
                            count = count + 4
                        # stacking position c
                        elif (stacking[l] == 'c'):
                            file.write(str(count) + "  1  0  " + str(Xshift + a_const / math.sqrt(3)) + "  " + str(Yshift) + "  " + str(Zshift) + "\n")
                            file.write(str(count+1) + "  1  0  " + str(Xshift + a_const * 2.0/math.sqrt(3)) + "  " + str(Yshift) + "  " + str(Zshift) + "\n")
                            file.write(str(count+2) + "  1  0  " + str(Xshift + a_const * math.sqrt(3)/6.0) + "  " + str(Yshift + a_const /2.0) + "  " + str(Zshift) + "\n")
                            file.write(str(count+3) + "  1  0  " + str(Xshift + a_const * math.sqrt(3)*5.0/6.0) + "  " + str(Yshift + a_const /2.0) + "  " + str(Zshift) + "\n")
                            count = count + 4
...
if __name__ == '__main__':
    ...
    lammps_gen_graphite_reaxff(verbose=True,forced=forced, cells=cells, stacking=stacking)
