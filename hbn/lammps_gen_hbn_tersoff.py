...
# This function simply generates a hbn lattice for the BNC.tersoff forcefield.
# The output is a lammps data file in atomic format (this is the required format for the BNC.tersoff code).
...
def lammps_gen_bnc_tersoff(**kwargs):

    # Default keyword args
    verbose = kwargs.get('verbose', False)
    forced = kwargs.get('forced', False)
    # Default constants for the AIREBO Potl
    a_const = kwargs.get('a_const', 2.4978645)
    ...
    if not forced:
        if os.path.isfile(filename):
            ...
            print("> lammps_gen_bnc_tersoff function wants to overwrite this file")
        ...
        for x in range(0, cells[0]):
            ...
            for y in range(0, cells[1]):
                ...
                file.write(str(count) + "  1  " +
                           ...
                           str(y_shift) + "  " +
                           str(z_shift) + "\n")
                file.write(str(count + 1) + "  2  " +
                           str(x_shift + a_const * 2.0 / math.sqrt(3)) + "  " +
                           str(y_shift) + "  " +
                           str(z_shift) + "\n")
                file.write(str(count + 2) + "  2  " +
...
if __name__ == '__main__':
    ...
    lammps_gen_bnc_tersoff(verbose=True, forced=True, cells=my_cells)
