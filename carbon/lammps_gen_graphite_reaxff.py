...
if __name__ == '__main__':
    ...
    if( len(sys.argv) > 1 ):
        ...
        # 4 params = cell size, user chosen stacking
            ...
            print("    examples")
            print("   lammps_gen_graphite_reaxff.py 1 2 3")
            print("   lammps_gen_graphite_reaxff.py 3 5 7 ab")
            print("   lammps_gen_graphite_reaxff.py 3 5 7 abc")
            print("   lammps_gen_graphite_reaxff.py 10 20 5 abcababcab")
            sys.exit()
