...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        # stacking
        while True:
            my_stacking = str(input('What stacking do you want (ab,abc)?: '))
            # if sys.version_info[0] < 3:
    ...
    lammps_gen_graphite_reaxff(verbose=True, forced=True, cells=my_cells, stacking=my_stacking)
