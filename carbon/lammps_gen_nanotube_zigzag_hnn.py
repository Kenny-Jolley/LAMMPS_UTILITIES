...
def lammps_gen_nanotube_zigzag_hnn(**kwargs):
    ...
    if not forced:
        if os.path.isfile(filename):
            ...
            print("> lammps_gen_nanotube_zigzag_hnn function wants to overwrite this file")
    ...
    if gen_file:
        ...
        # Write header info
        file.write("Lammps data file generated by lammps_gen_nanotube_zigzag_hnn\n")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        if len(sys.argv) == 3:
            ...
            print("    examples")
            print("   lammps_gen_nanotube_zigzag_hnn.py 1 2 ")
            print("   lammps_gen_nanotube_zigzag_hnn.py 10 21")
            sys.exit()
    else:
    ...
    lammps_gen_nanotube_zigzag_hnn(verbose=True, forced=True, cells=my_cells)
