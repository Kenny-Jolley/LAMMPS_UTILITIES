...
# This function simply generates a graphite lattice for the DRIP forcefield.
...
def lammps_gen_graphite_drip(**kwargs):
    ...
    if(not forced):
        if(os.path.isfile(filename)):
            ...
            print("> lammps_gen_graphite_drip function wants to overwrite this file")
    ...
    if(gen_file):
        ...
        # Write header info
        file.write("Lammps data file generated by lammps_gen_graphite_drip.py\n")
...
if __name__ == '__main__':
    ...
    lammps_gen_graphite_drip(verbose=True,forced=forced, cells=cells, stacking=stacking)
