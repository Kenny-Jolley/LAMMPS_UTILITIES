...
# This function simply generates a graphene lattice for the May 2016 ReaxFF forcefield.
...
def lammps_gen_graphene_reaxff(**kwargs):
    ...
    if gen_file:
        ...
        # Write header info
        file.write("Lammps data file generated by lammps_gen_graphene_reaxff\n")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        if len(sys.argv) == 3:
            ...
            print("    examples")
            print("   lammps_gen_graphene_reaxff.py 1 2 ")
            print("   lammps_gen_graphene_reaxff.py 10 21")
            sys.exit()
    else:
    ...
    lammps_gen_graphene_reaxff(verbose=True, forced=True, cells=my_cells)
