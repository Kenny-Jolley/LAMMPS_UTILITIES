...
def objective_funtion(params):
    ...
    lammps_gen_graphite_drip_airebo(verbose=False,
                             forced=True,
                             cells=cells,
                             stacking=stacking,
                             a_const=a_const,
    ...
    lmp.command("pair_style hybrid/overlay airebo 3.0 0 0 drip")
    lmp.command("pair_coeff * * airebo               CH.airebo  C")
