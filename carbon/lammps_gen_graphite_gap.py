...
# This function simply generates a graphite lattice for the GAP-20 forcefield.
# The output is a lammps data file in atomic format (this is the required format for the GAP code).
...
def lammps_gen_graphite_gap(**kwargs):
    ...
    if not forced:
        if os.path.isfile(filename):
            ...
            print("> lammps_gen_graphite_gap function wants to overwrite this file")
    ...
    if gen_file:
        ...
        # Write header info
        file.write("Lammps data file generated by lammps_gen_graphite_gap.py\n")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        # 4 params = cell size, user chosen stacking
            ...
            print("    examples")
            print("   lammps_gen_graphite_gap.py 1 2 3")
            print("   lammps_gen_graphite_gap.py 3 5 7 ab")
            print("   lammps_gen_graphite_gap.py 3 5 7 abc")
            print("   lammps_gen_graphite_gap.py 10 20 5 abcababcab")
            sys.exit()
    ...
    lammps_gen_graphite_gap(verbose=True, forced=True, cells=cells, stacking=stacking)
