...
from lammps_gen_graphite_airebo import lammps_gen_graphite_airebo
...
def objective_funtion(params):
    ...
    lammps_gen_graphite_airebo(verbose=False,
                             forced=True,
                             cells=cells,
                             stacking=stacking,
                             a_const=a_const,
