...
# This function generates a random lattice of Si and O atoms (SiO2 formula units).
...
def lammps_gen_random_SiO2_charge(**kwargs):
    ...
    total_mass = num_SiO2 * (si_mass + 2.0 * o_mass) * amu

    total_atoms = 3 * num_SiO2
    ...
    if verbose:
        ...
        print("  Oxygen atoms       : " + str(2 * num_SiO2))
    ...
    if not forced:
        if os.path.isfile(filename):
            ...
            print("> lammps_gen_random_SiO2_charge function wants to overwrite this file")
    ...
    # Write header info
    file.write("Lammps data file generated by lammps_gen_random_SiO2_charge\n")
    ...
    for i in range(1, num_SiO2 + 1):
        ...
        file.write(str(i) + "  2  " +
                   ...
                   str(atom_pos_z[i]) + "\n")
    # O atoms
    for i in range(num_SiO2 + 1, total_atoms + 1):
        # Output to file
        file.write(str(i) + "  1  " +
                   str(o_charge) + "  " +
                   str(atom_pos_x[i]) + "  " +
...
if __name__ == '__main__':
    ...
    lammps_gen_random_SiO2_charge(verbose=True,
                                  num_SiO2=_num_SiO2,
