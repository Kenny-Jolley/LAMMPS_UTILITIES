...
def lammps_gen_random_SiO2_B2O3_charge(**kwargs):
    ...
    file.write("#  Random lattice with " +
               ...
               str(no) + " O atoms (charge = " + str(o_charge) + "), at a density of " +
               str(density) + " kg/m^3\n")
    ...
    for i in range(1 + nsi, 1 + nsi + nb):
        ...
        file.write(str(i) + "  3  " +
                   ...
                   str(atom_pos_z[i]) + "\n")
    # O atoms
    for i in range(1 + nsi + nb, total_atoms + 1):
        # Output to file
        file.write(str(i) + "  1  " +
                   str(o_charge) + "  " +
                   str(atom_pos_x[i]) + "  " +
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        # 6 params = number of SiO2 and B2O3 formula units, Si charge, O charge, B charge and density
        if len(sys.argv) == 7:
        ...
        # 3 params = number of SiO2 and B2O3 formula units and density
        elif len(sys.argv) == 4:
            _num_SiO2 = int(sys.argv[1])
            _num_B2O3 = int(sys.argv[2])
            _density = float(sys.argv[3])
            ...
            print(">>> ERROR  <<<")
            print("  User must pass 3 command-line arguments")
            print("     number of SiO2 and B2O3 formula units and density")
            print("     example:")
            print("  lammps_gen_random_SiO2_B2O3_charge.py 700 300 2100")
            print("")

            print("or ")
            print("  User must pass 6 command-line arguments")
            print("     number of SiO2 and B2O3 formula units (integer),"
